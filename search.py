...
def ramificacion_acota(problem):
    return graph_search(problem, ramificacion_acotacion())

def H_ramificacion_acota(problem):
    return graph_search(problem, H_ramificacion_acotacion(problem))
